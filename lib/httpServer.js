...
var useHTTPS = config.tls && config.tls.cert;
  ...
  app.get('/socketemulator', function(req, res){
    res.sendFile('/home/dapolina/Documentos/Konker/workspace/knot-cloud-source/integration/konker/ws-script-client/index.html');
  });
