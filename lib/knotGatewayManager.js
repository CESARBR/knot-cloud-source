...
function isGateway(device){
    return device.type === "gateway" || device.uuid.substr(device.uuid.length - 4,4) === "0000";
}
...
module.exports.isGateway = function(device){
    return device.type === "gateway" || device.uuid.substr(device.uuid.length - 5, 4) === "0000";
}
