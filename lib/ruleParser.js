...
var LITERAL_PLACEHOLDER, PARAM_WITHOUT_VALUE_MESSAGE, _, fillLeafRestriction, fillTreeRestrictions, jsep, parseRules, setupJsep, util;
...
fillLeafRestriction = function(leaf, restriction) {
  ...
  ref = _.map(restriction.split("="), function(str) {
    return str.trim();
  }), leaf.param = ref[0], leaf.value = ref[1];
